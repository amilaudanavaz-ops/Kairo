<script lang="ts">
  ...
  function handleEmailContinue(e: SubmitEvent) {
    ...
    settingsStore.login(emailInput.trim(), nameInput.trim());
  }

  async function handleGoogleLogin() {
    isGoogleLoading = true;
    setTimeout(() => {
      settingsStore.login('amilavaz2003@gmail.com', 'Amila Vaz');
...
<div class="h-screen w-screen bg-[#111111] text-zinc-100 flex flex-col select-none overflow-hidden font-sans">
  <!-- Titlebar Header with Window Controls -->
