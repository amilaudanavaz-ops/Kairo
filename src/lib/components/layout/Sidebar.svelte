...
<aside class="w-56 bg-[#161616] border-r border-[#242424] flex flex-col justify-between shrink-0 select-none">
  ...
  <div class="p-3 border-t border-[#242424] bg-[#141414]">
    <button class="w-full flex items-center justify-center gap-2 py-1.5 px-3 bg-[#202020] hover:bg-[#282828] border border-[#2d2d2d] text-zinc-200 rounded-md text-xs font-medium transition-colors">
      <Link2 size={14} />
