...
pub async fn start_google_oauth(client_id: String) -> Result<AuthResponse, String> {
    ...
    // https://accounts.google.com/o/oauth2/v2/auth?client_id=404445257254-kgm0dkbb78ka72dkstpeo3uvg8qf8r5e.apps.googleusercontent.com&redirect_uri=http://127.0.0.1:8989&response_type=code&scope=https://www.googleapis.com/auth/calendar
